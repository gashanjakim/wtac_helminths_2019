...
plot_female<-ggplot(female,aes(V2,log10(V5)))+
	geom_point(alpha=0.5,size=0.5)+
	facet_grid(.~V1)+
	labs(title="Genome coverage of MHco3(ISE).N1_006",x="Genomic coordinate (bp)",y="Coverage per 100 kbp window (log10)")+
	theme_bw()+
	ylim(0,3)

plot_male<-ggplot(male,aes(V2,log10(V5)))+
	geom_point(alpha=0.5,size=0.5)+
	facet_grid(.~V1)+
	labs(title="Genome coverage of MHco3(ISE).N1_001",x="Genomic coordinate (bp)",y="Coverage per 100 kbp window (log10)")+
	theme_bw()+
	ylim(0,3)
